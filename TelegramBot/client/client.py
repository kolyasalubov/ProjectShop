...
PHONE_NUMBER = get_environment_variable("BOT_PHONE_NUMBER")      # Crete admin is_bot user and insert his/her phone_number
PASSWORD = get_environment_variable("BOT_PASSWORD")          # Crete admin is_bot user and insert his/her password
SERVER_HOST = get_environment_variable("SERVER_HOST")         # "http://localhost:8000/" insert for local testing
