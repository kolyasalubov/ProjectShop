...
from UserApp.views import UserViewSet, WishListViewSet, GetUserByTelegramIdViewSet
...
router.register(r'get_user_by_telegram_id', GetUserByTelegramIdViewSet, basename="user")
